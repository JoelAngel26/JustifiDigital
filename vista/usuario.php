			...
			<div class="full-box dashboard-sideBar-UserInfo">
				<figure class="full-box">
					...
					<figcaption class="text-center text-titles"><?php echo $_SESSION["usuario"]["nombre"]." ".$_SESSION["usuario"]["apaterno"]; ?></figcaption>
                                        <p class="text-center"><?php echo $_SESSION["usuario"]["privilegio"]; ?></p>
				</figure>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
                            <h1 class="text-titles">System <small><?php if($_SESSION["usuario"]["tutor"]=="Si"){ 
                                $result = SeleccionaGrupoTutor($_SESSION["usuario"]["iddocente"]);
                               $fila = $result->fetch_assoc();
                                
                                echo "Tutor del Grupo ".$fila['grado']." ".$fila['grupo'];
                            } ?></small></h1>
			</div>
		</div>
		<div class="full-box text-center" style="padding: 30px 10px;">
                     <div class="row">
                                <p><?php echo $_SESSION["usuario"]["iddocente"]?></p>
                                <p><?php echo $_SESSION["usuario"]["tutor"]?></p>
                                <p><?php echo $_SESSION["usuario"]["email"]?></p>
                                <p><?php echo $_SESSION["usuario"]["genero"]?></p>
                                <p><?php echo $_SESSION["usuario"]["privilegio"]?></p>
                            </div>
                    <?php
			...
			<article class="full-box tile">
				...
				<div class="full-box tile-number text-titles">
                    ...
                    <?php } if ($_SESSION["usuario"]["privilegio"] == "Director") { ?>
			<article class="full-box tile">
				<div class="full-box tile-title text-center text-titles text-uppercase">
					Director
				</div>
				...
				<div class="full-box tile-number text-titles">
                    ...
                    <?php } if ($_SESSION["usuario"]["privilegio"] == "Tutor") { ?>    
			<article class="full-box tile">
				<div class="full-box tile-title text-center text-titles text-uppercase">
                                        Tutor
				</div>
				...
				<div class="full-box tile-number text-titles">
                    ...
                    <?php } if($_SESSION["usuario"]["privilegio"] == "Docente"){ ?>
			<article class="full-box tile">
				<div class="full-box tile-title text-center text-titles text-uppercase">
					Docente
				</div>

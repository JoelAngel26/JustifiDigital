	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Grupos <small>activos sin tutor</small></h1>
			</div>
		</div>
		
		<div class="container-fluid">
		<?php
                $result = SeleccionaGruposSinTutor();
                
                ?>
                    
                    <a href="Grupos.php" class="btn btn-success">Grupos</a> 

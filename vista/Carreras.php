	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Carreras <small>activas</small></h1>
			</div>
		</div>
		
		<div class="container-fluid">
		<?php
                $result = SeleccionaCarreras();
                
                ?>
                    
                    <a href="addCarrera.php" class="btn btn-success">Nuevo</a>
                            ...
                            <tbody>
                                <?php while($fila= $result->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success" href="editCarrera.php?id=<?php echo $fila['idcarrera']; ?>">Editar</a>

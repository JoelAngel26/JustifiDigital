	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Tutores <small>Activos</small></h1>
			</div>
		</div>
		
		<div class="container-fluid">
		<?php
                $result = SeleccionaDocentesTutores();
                                ...
                                <?php while($fila= $result->fetch_assoc()) { ?>
                                    <tr>
                                       ...
                                       <td><?php echo $fila['estatus'] ?></td>
                                        ...
                                        <td>
                                            <a class="btn btn-success" href="editDocente.php?id=<?php echo $fila['iddocente']; ?>">Editar</a> | 

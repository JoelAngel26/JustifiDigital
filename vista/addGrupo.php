...
if(filter_input(INPUT_POST, 'btnGuardar')){
   $classDB = new Db();
    if(isset($_POST['tutor'])){
        ...
        if($tutor=="0"){
            $result2=$classDB->insertGrupoSinTutor($grado, $grupo, $sistema, $estatus, $carrera);
            if($result2==true){
                $success ="Grupo registrado exitosamente";
            } else {
                $error= "No fue posible el registro sin tutor";
            }
        }else{
            
            $result1=$classDB->insertGrupoWithTutor($grado, $grupo, $sistema, $estatus, $tutor, $carrera);
            if($result1==true){
                $success ="Grupo registrado exitosamente";
            } else {
                $error= "No fue posible el registro con tutor";
            }
        }
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Grupos <small>Cuatrimestrales</small></h1>
			</div>
		</div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-10 col-md-offset-1">
                            <form action="" method="POST">
                                <fieldset>Datos del Grupo</fieldset>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select name="tutor" class="form-control" >
                                        ...
                                        <?php
                                        $resultut = SeleccionaTutoresSI();
                                        if ($resultut->num_rows > 0) {
                                            while ($fila = $resultut->fetch_assoc()) {
                                                ?>

                                                <option value="<?php echo $fila['iddocente']; ?>"><?php echo $fila['nombre'] . " " . $fila['apaterno']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="carrera" class="form-control" required>
                                        <?php
                                        $resulCarreras = SeleccionaCarreras();
                                        if ($resulCarreras->num_rows > 0) {
                                            while ($fila = $resulCarreras->fetch_assoc()) {
                                                ?>

                                                <option value="<?php echo $fila['idcarrera']; ?>"><?php echo $fila['nomcarrera'] ?></option>

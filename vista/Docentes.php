	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Docentes <small>Activos</small></h1>
			</div>
		</div>
		
		<div class="container-fluid">
		<?php
                $result = SeleccionaDocentes();
                
                ?>
                    
                    <a href="addDocente.php" class="btn btn-success">Nuevo</a>
                            ...
                            <tbody>
                                <?php while($fila= $result->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $fila['apaterno']." ".$fila['amaterno']; ?></td>
                                       <td><?php echo $fila['estatus'] ?></td>
                                         <td><?php echo $fila['tutor'] ?></td>
                                        <td>
                                            <a class="btn btn-success" href="editDocente.php?id=<?php echo $fila['iddocente']?>&cuenta=<?php echo $fila['cuenta_idcuenta']; ?> ">Editar</a> | 
                                            <a class="btn btn-danger" href="deleteDocente.php?id=<?php echo $fila['iddocente']?>&cuenta=<?php echo $fila['cuenta_idcuenta']; ?> " onclick="return confirm('¿Seguro que quieres eliminarlo?');">Eliminar</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>

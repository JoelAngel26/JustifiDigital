...
if(filter_input(INPUT_POST, 'btnGuardar')){
	...
	$fF = $_POST['fechaF'];
        ...
        if( $client->__soapCall("insertPeriodo", array($nom, $fI, $fF,$anio,$des))  ){
                ...
                ?>
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="fechaI" class="form-control" type="date" required>
                        </div>
                          <div class="form-group">
                            <label class="control-label">Fecha Fin</label>
                            <input name="fechaF" class="form-control" type="date"  required >
                        </div>
                        <div class="form-group label-floating">
                            <label class="control-label">Año</label>
                            <input name="anio" class="form-control" type="text"  required>
                        </div>
                        <div class="form-group label-floating">

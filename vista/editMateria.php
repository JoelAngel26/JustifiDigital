...
if(filter_input(INPUT_POST, 'btnGuardar')){
    ...
    $classDB = new Db();
    $resulta = $classDB->updateMateria($idx, $nom, $horas, $des, $estatus);
    if($resulta==true){
...
$id = $_GET['id'];
$result = ObtenerMateriaBYID($id);
$filam= $result->fetch_assoc();
?>
		 ...
		 <div class="row">
                        <div class="col-xs-12 col-md-10 col-md-offset-1">
                            <form action="" method="POST">
                                <fieldset>Datos de la Materia</fieldset>
                                ...
                                <div class="form-group label-floating">
                                    ...
                                    <input name="horas" class="form-control" type="text" value="<?php echo $filam['horas']; ?>" required>
                                </div>
                                <div class="form-group label-floating">
                                    <label class="control-label">Descripcion</label>
                                    <input name="des" class="form-control" type="text" value="<?php echo $filam['descripcion']; ?>" required>
                                </div>

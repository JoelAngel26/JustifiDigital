	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles">Grupos <small>activos</small></h1>
			</div>
		</div>
		
		<div class="container-fluid">
		<?php
                $result = SeleccionaGrupos();
                
                ?>
                    
                    <a href="addGrupo.php" class="btn btn-success">Nuevo</a>  <a href="grupos-sin-tutor.php" class="btn btn-link">Grupos sin Tutor</a>
                  <table class="table table-hover table-bordered">
                            <thead style="background-color: #337ab7; color: white; font-style: initial oblique  ;">
                                <tr>
                                    <td>Grado y Grupo</td>
                                    <td>Sistema</td>
                                    <td>Estatus</td>
                            ...
                            <tbody>
                                <?php while($fila= $result->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $fila['sistema'] ?></td>
                                        <td><?php echo $fila['estatus']; ?></td>
                                       <td><?php echo $fila['nombre']." ".$fila['apaterno']; ?></td>
                                       <td><?php echo $fila['nomcarrera']; ?></td>
                                       
                                        <td>
                                            <a class="btn btn-success" href="editCarrera.php?id=<?php echo $fila['idgrupo']; ?>">Editar</a>
                                          
                                        </td>
                                        <td>
                                            <a class="btn btn-success" href="grupo_alumnos.php?id=<?php echo $fila['idgrupo']; ?>">Alumnos</a>|
                                            <a class="btn btn-success" href="grupo_materias.php?id=<?php echo $fila['idgrupo']; ?>">Materias</a>

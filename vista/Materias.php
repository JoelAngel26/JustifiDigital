...
<section class="full-box cover dashboard-sideBar">
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
		<?php
                $result = SeleccionaMaterias();
                
                ?>
                    
                    <a href="addMateria.php" class="btn btn-success">Nuevo</a>
                            ...
                            <tbody>
                                <?php while($fila= $result->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success" href="editMateria.php?id=<?php echo $fila['idmateria']; ?>">Editar</a> | 
                                            <a class="btn btn-danger" href="deleteMateria.php?id=<?php echo $fila['idmateria']; ?>" onclick="return confirm('¿Seguro que quieres eliminarlo?');">Eliminar</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>

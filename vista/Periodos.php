	...
	<section class="full-box dashboard-contentPage">
		...
		<?php
                ...
                ?>
                    ...
                    <a href="addPeriodo.php" class="btn btn-success">Nuevo</a>
                            ...
                            <tbody>
                                <?php foreach ($result as $row) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success" href="editPeriodo.php?id=<?php echo $row['periodo_id']; ?>">Editar</a> | 
                                            <a class="btn btn-danger" href="deletePeriodo.php?id=<?php echo $row['periodo_id']; ?>" onclick="return confirm('¿Seguro que quieres eliminarlo?');">Eliminar</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
